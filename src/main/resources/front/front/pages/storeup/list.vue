	...
	<view class="content">
		<view :style='{"minHeight":"100vh","padding":"24rpx 0 24rpx","alignItems":"flex-start","flexWrap":"wrap","background":"#f2f2f2","display":"block","width":"100%","position":"relative","height":"auto"}'>
			...
			<view :style='{"padding":"0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
				<view class="uni-product-list" :style='{"minHeight":"100vh","padding":"32rpx 24rpx 0","margin":"40rpx auto 0","borderRadius":"0px","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","flex":"1","display":"block","width":"calc(100% - 200rpx)","justifyContent":"space-between","height":"auto"}'>
					<view @tap="onDetailTap(product)" class="uni-product" :style='{"width":"100%","margin":"0 0 40rpx","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}' v-for="(product,index) in list" :key="index">
						<view class="uni-product-title " :style='{"padding":"4rpx 20rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis"}'>{{product.name}}</view>
		...
		<button :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"128rpx","right":"128rpx","borderRadius":"100%","background":"#38bf3e","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('storeup','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"128rpx","right":"128rpx","borderRadius":"100%","background":"#38bf3e","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="!userid && isAuthFront('storeup','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
</mescroll-uni>
</template>
