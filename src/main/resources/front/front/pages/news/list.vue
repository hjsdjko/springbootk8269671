	...
	<view class="content">
		<view :style='{"minHeight":"100vh","padding":"24rpx 0 24rpx","alignItems":"flex-start","flexWrap":"wrap","background":"#f2f2f2","display":"block","width":"100%","position":"relative","height":"auto"}'>
			...
			<view :style='{"padding":"0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
				...
				<!-- 样式1 -->
				<view class="news-box1" :style='{"minHeight":"100vh","padding":"24rpx 24rpx","margin":"40rpx auto 0","borderRadius":"0px","color":"#999","background":"#fff","flex":"1","display":"block","width":"calc(100% - 200rpx)","height":"auto"}'>
		...
		<button :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"128rpx","right":"128rpx","borderRadius":"100%","background":"#38bf3e","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('news','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"128rpx","right":"128rpx","borderRadius":"100%","background":"#38bf3e","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="!userid && isAuthFront('news','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
</mescroll-uni>
</template>
