<template>
	<view :style='{"minHeight":"100vh","padding":"20rpx 0","flexWrap":"wrap","background":"#f2f2f2","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<view class="title" :style='{"margin":"0","color":"#333","borderRadius":"0px 0px 0 0","textAlign":"center","background":"#ffffff","width":"100%","lineHeight":"80rpx","fontSize":"32rpx"}'>{{detail.title}}</view>
		...
		<view :style='{"padding":"0 20rpx 32rpx 0","alignItems":"center","borderRadius":"0 0 0px 0","background":"#fff","display":"flex","width":"40%","justifyContent":"space-between","order":"8"}'>
		...
		<div :style='{"padding":"0 24rpx 32rpx 24rpx","alignItems":"center","borderRadius":"0 0 0 0px","background":"#ffffff","display":"flex","width":"60%","justifyContent":"space-between","height":"auto"}'>
		...
		<!-- 热门 -->
		<view class="hot" :style='{"padding":"24rpx","margin":"0px 0","borderRadius":"0px","background":"#fff","width":"100%","height":"auto","order":"11"}'>
		  <view :style='{"padding":"0 0px","borderColor":"#38bf3e","margin":"20rpx 0 0","color":"#333","textAlign":"left","background":"none","borderWidth":"0 0 0 0px","width":"100%","fontSize":"32rpx","lineHeight":"1","borderStyle":"solid","fontWeight":"600","height":"auto"}'>热门信息</view>
		...
		<!-- 推荐 -->
		<view class="recommend" :style='{"padding":"24rpx","margin":"20rpx 0","borderRadius":"0px","background":"#fff","display":"none","width":"100%","height":"auto","order":"12"}'>
