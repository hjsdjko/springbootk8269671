<template>
	<div class="navbar">
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"fontSize":"inherit","position":"fixed","right":"20px","color":"inherit","display":"inline-block","zIndex":"9999"}'>
		  <div class="el-dropdown-link" :style='{"alignItems":"center","display":"flex"}'>
		    ...
		    <span :style='{"lineHeight":"32px","fontSize":"14px","color":"inherit","display":"none"}'>{{this.$storage.get('adminName')}}</span>
